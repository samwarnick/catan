...
public class BoardTest {
	...
	public void testGenerateBoard() {
		...
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.ORE);
		i++;
		assertEquals(resourceHexes.get(i).getLocation().getX(), -2);
		assertEquals(resourceHexes.get(i).getLocation().getY(), 1);
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.WHEAT);
		i++;
		assertEquals(resourceHexes.get(i).getLocation().getX(), -2);
		assertEquals(resourceHexes.get(i).getLocation().getY(), 2);
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.WOOD);
		i++;
		assertEquals(resourceHexes.get(i).getLocation().getX(), -1);
		assertEquals(resourceHexes.get(i).getLocation().getY(), -1);
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.BRICK);
		i++;
		assertEquals(resourceHexes.get(i).getLocation().getX(), -1);
		assertEquals(resourceHexes.get(i).getLocation().getY(), 0);
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.SHEEP);
		i++;
		assertEquals(resourceHexes.get(i).getLocation().getX(), -1);
		assertEquals(resourceHexes.get(i).getLocation().getY(), 1);
		assertEquals(resourceHexes.get(i).getLandType(), ResourceType.SHEEP);
