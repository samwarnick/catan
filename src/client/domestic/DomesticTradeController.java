...
public class DomesticTradeController extends Controller implements IDomesticTradeController {
	...
	public void setPlayerToTradeWith(int playerIndex) {
		...
		if ((woodStatus == 1 || brickStatus == 1 || sheepStatus == 1 || wheatStatus == 1 || oreStatus == 1) && (woodStatus == -1 || brickStatus == -1 || sheepStatus == -1 || wheatStatus == -1 || oreStatus == -1) && (woodNum + sheepNum + wheatNum+brickNum+oreNum)>2)
		{
			if (playerIndex != -1)
			{
